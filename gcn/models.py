...
class GCN(Model):
    ...
    def _f1_score(self):
        self.f1_score = masked_f1(self.outputs, self.placeholders['labels'],
                                        self.placeholders['labels_mask'])

    def _truePositive(self):
        self.TP = masked_TP(self.outputs, self.placeholders['labels'],
                                        self.placeholders['labels_mask'])

    def _falsePositive(self):
        self.FP = masked_FP(self.outputs, self.placeholders['labels'],
                            self.placeholders['labels_mask'])
